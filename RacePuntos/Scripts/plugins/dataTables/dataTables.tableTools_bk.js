...
TableTools.prototype = {
  ...
  /* ----- BEGIN added code ----- */
  /*
   * Thanks to lisarush from datatables.net forum <3 life-saver
   */
  /**
   * metodo agregado.
   * @returns {dataTables.tableTools_L33.factory.dataTables.tableTools_L443.TableTools.prototype._fnGetHeaders.matrix}
   */
  ...
  /* ----- END added code ----- */    
	...
	"_fnGetDataTablesData": function ( oConfig )
	{
		...
		{
      /* ----- BEGIN changed Code ----- */
      /* Thanks to lisarush from datatables.net forums <3 */
